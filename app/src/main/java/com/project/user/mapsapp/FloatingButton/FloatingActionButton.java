...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, com.getbase.floatingactionbutton.R.styleable.FloatingActionButton, 0, 0);
        mColorNormal = attr.getColor(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
        mSize = attr.getInt(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_size, SIZE_NORMAL);
        mIcon = attr.getResourceId(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_icon, 0);
        mTitle = attr.getString(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_title);
        mStrokeVisible = attr.getBoolean(com.getbase.floatingactionbutton.R.styleable.FloatingActionButton_fab_stroke_visible, true);
        attr.recycle();

        updateCircleSize();
        mShadowRadius = getDimension(com.getbase.floatingactionbutton.R.dimen.fab_shadow_radius);
        mShadowOffset = getDimension(com.getbase.floatingactionbutton.R.dimen.fab_shadow_offset);
        updateDrawableSize();
    ...
    private void updateCircleSize() {
        mCircleSize = getDimension(mSize == SIZE_NORMAL ? com.getbase.floatingactionbutton.R.dimen.fab_size_normal : com.getbase.floatingactionbutton.R.dimen.fab_size_mini);
    }
    ...
    TextView getLabelView() {
        return (TextView) getTag(com.getbase.floatingactionbutton.R.id.fab_label);
    }
    ...
    void updateBackground() {
        final float strokeWidth = getDimension(com.getbase.floatingactionbutton.R.dimen.fab_stroke_width);
        final float halfStrokeWidth = strokeWidth / 2f;

        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[] {
                        getResources().getDrawable(mSize == SIZE_NORMAL ? com.getbase.floatingactionbutton.R.drawable.fab_bg_normal : com.getbase.floatingactionbutton.R.drawable.fab_bg_mini),
                        createFillDrawable(strokeWidth),
                        createOuterStrokeDrawable(strokeWidth),
                        getIconDrawable()
                });

        int iconOffset = (int) (mCircleSize - getDimension(com.getbase.floatingactionbutton.R.dimen.fab_icon_size)) / 2;
